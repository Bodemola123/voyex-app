...
function Welcome() {
  ...
  return (
    <main className="relative max-w-[666px] w-full h-[600px] z-[2] flex flex-col items-center justify-center p-6 rounded-[29px] bg-black overflow-y-scroll">
      <div className=" flex flex-col items-center justify-center h-full">
        ...
        <p className="absolute bottom-0 text-center text-fontlight text-base font-normal">
