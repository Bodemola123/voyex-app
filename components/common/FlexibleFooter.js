...
function FlexibleFooter() {
  return (
    <div className="flex items-center justify-center w-full z-1">
      <div className="flex items-center justify-center gap-6 text-base tracking-wider text-fontlight font-light bg-[#0A0A0B]  backdrop-blur-[6.8px] px-4 py-3 rounded-lg mx-auto">
