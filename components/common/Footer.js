...
function Footer() {
  return (
    <div className="absolute bottom-[2vh] left-[50vw] -translate-x-[50vw] w-full z-1">
      <div className="flex items-center justify-center gap-[1vw] text-[2vh] text-fontlight font-normal bg-[#0A0A0B]  backdrop-blur-[6.8px] w-[32vw] h-[7vh] rounded-lg mx-auto">
