...
function ContactDetailsContainer({
  ...
  return (
    <main className="relative grid grid-cols-2 gap-1 w-full h-full z-[2] p-4 overflow-y-auto scrollbar-hide overflow-x-hidden items-center justify-center">
      <DynamicCard />
      <div className=" flex flex-col items-center justify-center h-full max-w-[444px] py-[33px] w-full mx-auto rounded-[29px] text-white border border-[#D0D5DD1A] bg-black overflow-y-scroll scrollbar-hide">
