...
function ComplianceandCert ({
  ...
  return (
    <main className="relative grid grid-cols-2 gap-1 w-full h-full z-[2] p-4 overflow-y-auto overflow-x-hidden scrollbar-hide items-center justify-center">
      <DynamicCard />
      <div className="flex flex-col items-center justify-center h-full max-w-[647px] py-[33px] w-full mx-auto rounded-[29px] text-white border border-[#D0D5DD1A] bg-[#1C1D1F]overflow-y-scroll scrollbar-hide">
        ...
        <div className="space-y-[6px] w-full px-2">
          <label className="text-white font-normal flex flex-row gap-1 items-center">
