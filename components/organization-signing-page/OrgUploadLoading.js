...
function OrgUploadLoading() {
  return (
    <main className="relative max-w-[666px] w-full h-[600px] z-[2] p-6 rounded-[29px] bbg-[#1C1D1F] overflow-y-scroll">
      <div className=" flex flex-col items-center justify-center gap-7 h-full">
        ...
        <p className="text-base text-fontlight text-center font-light">
          Please wait while data is uploaded
        </p>
      </div>
...
export default OrgUploadLoading;
