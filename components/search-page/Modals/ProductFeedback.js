      ...
      <div className="bg-[#1c1d1f] text-white rounded-[24px] gap-8 py-[30px] px-[29px] flex flex-col relative max-w-[513px]">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className="px-4 py-[18px] resize-none rounded-[28px] bg-[#0a0a0b] text-[#FFFFFF] placeholder-[#FFFFFF] h-[153px] placeholder:text-base placeholder:font-normal font-normal text-base leading-none text-start outline-0 focus:ring-0"
            value={feedback}
