...
const Body = () => {
  ...
  return (
    <div className='grid grid-cols-4 gap-8'>
        ...
        <div className='border rounded-[18px] border-card h-[327.76px] bg-cover bg-center bg-no-repeat flex justify-center items-center' style={{ backgroundImage: "url('/Logged-in.svg')" }}>
